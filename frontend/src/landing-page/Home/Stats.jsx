    ...
    return (
        ...
        <div className='container p-3'>
            ...
            <div className='row p-5'>
                ...
                <div className='col-6'>
                    <img src="media/images/ecosystem.png" alt="Ecosytem image" style={{ width: "90%" }} />
                    ...
                    <div className='text-center'>
                        ...
                        <a href="" style={{textDecoration:"none"}}>Try our Kite  <i class="fa fa-long-arrow-right" aria-hidden="true"></i>
                        </a>
